...
% SEE BELOW >>>> SPECIAL <<<<< 
% USE FIXED initial W to match the XOR_2_iteration runs 
...
% >>>> DEACTIVATE FIRST SECTION SO USE SAVED WORKSPACE <<<<< 
...
% >>>> SPECIAL <<<<<
clear W
W{1} = [0.1134 0.3317; -0.3898 -0.7215; -0.4444 -0.8602]
W{2} = [-0.6039 0.7297 0.8916]
...
tn = 3; % uses tn several places below, which single input to use 
